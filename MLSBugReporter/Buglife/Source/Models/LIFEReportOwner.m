...
@property (nonatomic, assign) LIFEReportOwnerType ownerType;
@property (nonatomic, copy) NSString *ownerIdentifier;    // this is an API key, or email address, depending on the owner type
