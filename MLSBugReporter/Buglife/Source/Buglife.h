...
/// Crash report
extern LIFEAttachmentType * __nonnull const LIFEAttachmentTypeIdentifierCrashText;
 ...
 */
@property (nonatomic, assign) LIFEInvocationOptions invocationOptions;

/**
 *  Specifies the retry policy for submitting bug reports.
 *  This returns LIFERetryPolicyNextLaunch by default.
 */
@property (nonatomic, assign) LIFERetryPolicy retryPolicy;
...
/**
 * Whether certain UIControl and navigation events will be logged. Defaults to `NO`
 */
@property (nonatomic, assign) BOOL captureUserEventsEnabled;
