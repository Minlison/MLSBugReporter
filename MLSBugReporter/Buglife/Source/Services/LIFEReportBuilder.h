...
@property (nonatomic, strong, nullable) NSArray<LIFEReproStep *> *reproSteps;
...
@property (nonatomic, strong, nullable) NSDictionary<NSString *, LIFEAttribute *> *attributes;
@property (nonnull, nonatomic, strong, readonly) NSArray<LIFEReportAttachmentImpl *> *nonImageAttachments;
// This should only be accessed on the main thread!
@property (nonnull, nonatomic, strong, readonly) NSArray<LIFEUserFacingAttachment> *userFacingAttachments;
