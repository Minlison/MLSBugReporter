...
@property (nonatomic, assign) LIFELogLevel logLevel;
@property (nonatomic, strong) LIFEFileLogger *fileLogger;
@property (nonatomic, strong) dispatch_queue_t workQueue;
@property (nonatomic, strong) LIFENotificationLogger *notificationLogger;
...
@property (nonatomic, assign) BOOL consoleLoggingEnabledImpl;
