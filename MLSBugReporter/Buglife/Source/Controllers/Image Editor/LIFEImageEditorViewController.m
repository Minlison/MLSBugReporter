...
@property (nonatomic, null_resettable, strong) UIBarButtonItem *cancelButton;
@property (nonatomic, null_resettable, strong) UIBarButtonItem *nextButton;
...
@property (null_resettable, nonatomic, strong) UIPanGestureRecognizer *panGestureRecognizer;
@property (null_resettable, nonatomic, strong) LIFEFreeformGestureRecognizer *freeformGestureRecognizer;
@property (null_resettable, nonatomic, strong) UITapGestureRecognizer *tapGestureRecognizer;
