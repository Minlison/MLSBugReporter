...
@property (nonatomic, strong) UIView *imageBorderView;
@property (nonatomic, strong) LIFEImageEditorSegmentedControl *segmentedControl;
@property (nonatomic, strong) LIFEScreenshotAnnotatorView *screenshotAnnotatorView;
@property (nonatomic, strong) NSLayoutConstraint *segmentedControlBottomConstraint;
