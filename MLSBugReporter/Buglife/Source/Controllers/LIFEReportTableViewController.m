...
@property (nonatomic, strong) LIFEImagePickerController *imagePickerController;
@property (nonatomic, strong) LIFEReportBuilder *reportBuilder;
@property (nonatomic, assign) NSInteger indexOfCurrentEditingAnnotatedImage; // kNoCurrentEditingAnnotatedImage if nothing
@property (nonatomic, strong) UIBarButtonItem *doneButton;
@property (nonatomic, strong) NSMutableDictionary<LIFEInputField *, NSString *> *inputFieldValues;
@property (nonatomic, strong) NSArray<LIFEReproStep *> *reproSteps;
...
@property (nonatomic, strong, nonnull) NSMutableDictionary<LIFEInputField *, NSNumber *> *inputFieldRowHeightCache;
...
@property (nonatomic, assign, readonly) BOOL addAttachmentsButtonEnabled;
...
- (instancetype)initWithReportBuilder:(LIFEReportBuilder *)reportBuilder context:(nullable LIFEScreenshotContext *)context
{
    ...
    if (self) {
        ...
        _inputFields = [Buglife sharedBuglife].inputFields;
