...
@property (nonatomic, assign) BOOL statusBarOverridesEnabled;
@property (nonatomic, assign) BOOL statusBarHiddenOverride;
@property (nonatomic, assign) UIStatusBarStyle statusBarStyleOverride;
