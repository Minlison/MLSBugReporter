...
#define MLSFLEXFloor(x) (floor([[UIScreen mainScreen] scale] * (x)) / [[UIScreen mainScreen] scale])

#if defined(__IPHONE_11_0)
#define MLSFLEX_AT_LEAST_IOS11_SDK (__IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_11_0)
#else
#define MLSFLEX_AT_LEAST_IOS11_SDK NO
#endif

@interface MLSFLEXUtility : NSObject
