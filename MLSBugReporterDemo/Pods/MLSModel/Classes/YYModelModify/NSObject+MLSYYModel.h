 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `MLSYYModel` protocol for custom methods.
 ...
 */
@interface NSDictionary (MLSYYModel)
...
/**
 ...
 There's no need to add '<MLSYYModel>' to your class header.
 */
@protocol MLSYYModel <NSObject>
@optional
