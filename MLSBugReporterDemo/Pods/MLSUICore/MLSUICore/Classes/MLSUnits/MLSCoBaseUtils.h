...
typedef NS_OPTIONS(NSUInteger, iPhoneType) {
     ...
     * 5.8英寸
     */
    iPhoneTypeInches_5_8 = iPhoneTypeX | iPhoneTypeXS,
    /**
     * 6.1英寸
     */
    iPhoneTypeInches_6_1 = iPhoneTypeXR,
    /**
     * 6.5英寸
     */
    iPhoneTypeInches_6_5 = iPhoneTypeXS_MAX,
    /**
     * 顶部有刘海
     */
    iPhoneTypeLikeXScreen = iPhoneTypeX | iPhoneTypeXS | iPhoneTypeXR | iPhoneTypeXS_MAX,
};
...
/**
 ...
 @param imageURL 图片地址
 @param completion 回调，如果失败，则 imgSize 为 CGSizeZero
 */
